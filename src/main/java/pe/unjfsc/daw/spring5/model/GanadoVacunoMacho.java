...
public class GanadoVacunoMacho {
	...
	public String getEtapaGana() {
		return etapaGana;
	}
	public void setEtapaGana(String etapaGana) {
		this.etapaGana = etapaGana;
	}
	...
	public String getIdTipoGana() {
		return idTipoGana;
	}
	public void setIdTipoGana(String idTipoGana) {
	...
	public String toString() {
		return "GanadoVacunoMacho [cuiaGana=" + cuiaGana + ", edadGana=" + edadGana + ", etapaGana=" + etapaGana
				...
				+ codiPropInse + ", obse=" + obse + ", imagen=" + imagen + "]";
	}
