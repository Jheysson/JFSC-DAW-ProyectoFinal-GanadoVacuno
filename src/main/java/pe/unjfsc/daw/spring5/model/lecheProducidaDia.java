...
public class lecheProducidaDia {
	...
	public double getCantiLitrLechProd() {
		return cantiLitrLechProd;
	}
	public void setCantiLitrLechProd(double cantiLitrLechProd) {
		this.cantiLitrLechProd = cantiLitrLechProd;
	}
